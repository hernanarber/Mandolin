...
namespace stk {
    ...
    {
        if ( rate < 0.0 ) {
            errorString_ << "ADSR::setAttackRate: argument must be >= 0.0!";
    ...
    {
        if ( target < 0.0 ) {
            errorString_ << "ADSR::setAttackTarget: negative target not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( rate < 0.0 ) {
            errorString_ << "ADSR::setDecayRate: negative rates not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( level < 0.0 ) {
            errorString_ << "ADSR::setSustainLevel: negative level not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( rate < 0.0 ) {
            errorString_ << "ADSR::setReleaseRate: negative rates not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( time <= 0.0 ) {
            errorString_ << "ADSR::setAttackTime: negative or zero times not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( time <= 0.0 ) {
            errorString_ << "ADSR::setDecayTime: negative or zero times not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( time <= 0.0 ) {
            errorString_ << "ADSR::setReleaseTime: negative or zero times not allowed!";
            handleError( StkError::WARNING ); return;
        }
    ...
    {
        if ( target < 0.0 ) {
            errorString_ << "ADSR::setTarget: negative target not allowed!";
            handleError( StkError::WARNING ); return;
        }
